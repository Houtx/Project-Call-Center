              ...
              <section className="policy-pane">
                ...
                <Form form={policyForm} layout="vertical" requiredMark={false} onFinish={saveMobilePolicy}>
                  <div className="two-column-form">
                    ...
                    <Form.Item className="form-span-2" name="recordingRetentionDays" label="录音保留天数" rules={[{ required: true, message: '请设置录音保留天数' }]} extra="后台任务每小时清理超过此期限的录音文件，只保留通话记录元数据。"><InputNumber min={1} max={365} precision={0} addonAfter="天" style={{ width: '100%' }} /></Form.Item>
